...
router.patch("/products/:id/department-prices/:departmentId", ...managerManage, patchProductDepartmentPrice);
router.post("/products/:id/images", ...managerManage, upload.single("product_image"), addProductImage);
